...
namespace System.Windows.Controls.Theming
{
    ...
    {
        public static Color WindowColor = Colors.LightGray;
        public static Color ControlColor = Colors.LightGray;
        public static Color ControlLightLightColor = Colors.White;
        public static Color ActiveBorderColor = Colors.Red;
        public static Color ActiveCaptionColor = Colors.Blue;
        public static Color ActiveCaptionTextColor = Colors.Green;
        public static Color AppWorkspaceColor = Colors.LightGray;
        public static Color ControlDarkColor = Colors.Gray;
        public static Color ControlDarkDarkColor = Colors.DarkGray;
        public static Color ControlLightColor = Colors.WhiteSmoke;
        public static Color ControlTextColor = Colors.Beige;
        public static Color DesktopColor = Colors.Pink;
        public static Color GrayTextColor = Colors.Gray;
        public static Color HighlightColor = Colors.Yellow;
        public static Color HighlightTextColor = Colors.Lime;
        public static Color InactiveBorderColor = Colors.HotPink;
        public static Color InactiveCaptionColor = Colors.Violet;
        public static Color InactiveCaptionTextColor = Colors.PaleVioletRed;
        public static Color InfoColor = Colors.Aquamarine;
        public static Color InfoTextColor = Colors.LightCyan;
        public static Color MenuColor = Colors.DarkBlue;
        public static Color MenuTextColor = Colors.LightBlue;
        public static Color ScrollBarColor = Colors.OrangeRed;
        public static Color WindowFrameColor = Colors.HotPink;
        public static Color WindowTextColor = Colors.Lavender;
    }
}
