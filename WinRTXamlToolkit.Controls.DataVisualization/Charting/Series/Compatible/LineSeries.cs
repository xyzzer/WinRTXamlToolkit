...
#else
namespace WinRTXamlToolkit.Controls.DataVisualization.Charting.Compatible
#endif
{
    /// <summary>
    ...
    public class LineSeries : StackedLineSeries
    {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Polyline", Scope = "member", Target = "WinRTXamlToolkit.Controls.DataVisualization.Charting.Compatible.LineSeries.#PolylineStyle", Justification = "Matches spelling of same-named framework class.")]
